...
void ApplicationManager::addContextProperty(QQmlEngine *engine, QQmlContext *context)
{
    ...
    qmlRegisterType<MemberListingViewModel>("XApps.XOrmDemoOne", 1, 0, "MemberListingViewModel");
    qmlRegisterType<MemberEditionViewModel>("XApps.XOrmDemoOne", 1, 0, "MemberEditionViewModel");
    qmlRegisterType<MemberDetailsViewModel>("XApps.XOrmDemoOne", 1, 0, "MemberDetailsViewModel");
}
